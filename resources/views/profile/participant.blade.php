...
@section('content')
    ...
    <section class="participant-profile participant-profile-layout">
        <aside class="participant-profile-menu" aria-label="Menu profil">
            ...
            <details class="participant-password-menu" @if ($errors->hasAny(['current_password', 'password'])) open @endif>
                <summary><span aria-hidden="true">🔒</span> Ubah Password</summary>
                <div class="participant-password-dropdown">
                    <div class="participant-password-dropdown-heading">
                        <div>
                        ...
                        <label>Password Baru
                            <span class="password-field">
                                ...
                                <button type="button" data-password-toggle aria-label="Lihat password baru" title="Lihat password">
                                    <svg class="eye-open" viewBox="0 0 24 24" aria-hidden="true"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                    <svg class="eye-closed" viewBox="0 0 24 24" aria-hidden="true"><path d="m3 3 18 18M10.6 10.6a3 3 0 0 0 4.2 4.2M9.9 4.4A10.4 10.4 0 0 1 12 4c6.5 0 10 8 10 8a18.7 18.7 0 0 1-3.1 4.1M6.7 6.7C3.6 8.8 2 12 2 12s3.5 8 10 8a10.8 10.8 0 0 0 4.3-.9"></path></svg>
                                </button>
                            </span>
